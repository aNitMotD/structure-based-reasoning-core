# LCIF Case — Spreadsheet AI ‘Top-10 Average’ Interpretation Collapse

## Classification
- Failure type: LCIF (Layered Constraint Inheritance Failure)
- Status: confirmed
...
## 4. LCIF Occurrence Path

LCIF occurred through the following path:
...
This is a canonical LCIF pattern.
...
- LCIF can occur in **low‑risk, everyday spreadsheet tasks**
...
Structurally, this case is **isomorphic** to higher‑complexity LCIF cases, but occurs at a much lower dimensional cost.
